...
QUERY_TEXTS=(alluvial_fans glacier-like_form landslides pitted_cones slope_streaks yardangs)

# model (OpenCLIP by default)
MODEL_NAME=ViT-L-14-quickgelu
PRETRAINED=dfn2b
RESUME_POST_TRAIN=/mnt/sharedata/ssd_large/Planet/PlanetCLIP/model/logs/post_training/ckpt/v2_mini_20251226_131303_ViT-L-14-quickgelu_dfn2b_None/checkpoints/epoch_latest.pt
