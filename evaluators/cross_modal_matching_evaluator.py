...
class CrossModalMatchingEvaluator(EvaluatorBase):
    ...
    def summary(self, args, args_dynamic, eval_summary: Dict):
        ...
        row = [
            ...
            round(eval_summary.get("i2t_r5", 0.0) * 100, 2) if eval_summary else "",
            ...
            round(eval_summary.get("t2i_r5", 0.0) * 100, 2) if eval_summary else "",
